...
public class FederClass extends FederBody implements FederHeaderGen, FederCompileGen
{
	...
	public String generateInCompile()
	{
		...
		result.append(generateCName() + " fdCreateClass_").append(generateCNameOnly()).append(" () {\n");
		result.append("  ").append(generateCName()).append(" result = (" + generateCName() + ") malloc (sizeof (" + generateCNameOnly() + "));\n");
		result.append("  ").append("result->usage = 1;\n");
		result.append("  ").append("result->usagefn = ").append("fdIncreaseUsage_");
		result.append(generateCNameOnly()).append(";\n");
		result.append("  ").append("result->delfn = ").append("fdDeleteClass_").append(generateCNameOnly()).append(";\n");
